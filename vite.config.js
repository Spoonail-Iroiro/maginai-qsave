...
export default defineConfig({
  build: {
    target: 'es2015',
    outDir: resolve(__dirname, 'game/game/js/mod/mods/qsave'),
    emptyOutDir: true,
    lib: {
      entry: resolve(__dirname, 'js/mod/mods/qsave/init.js'),
      name: 'qsave',
      formats: ['iife'],
    },
    rollupOptions: {
  ...
  plugins: [
    {
      ...
      closeBundle: async () => {
        const devRoot = 'js/mod/mods/qsave';
        const buildRoot = 'game/game/js/mod/mods/qsave';
        try {
